...
This project gives you a **complete browser automation scaffold** for Blackboard LMS using Puppeteer (self-hosted, open source) or [AnchorBrowser](https://anchorbrowser.io) (cloud, managed, production-ready).
...
*Built with ❤️ for developers who need to automate Blackboard LMS without wrestling with its API limitations. Powered by [AnchorBrowser](https://anchorbrowser.io) for cloud-scale automation.*
