/**
 * basic-login.js — Basic login example for Blackboard LMS
...
async function main() {
  ...
  try {
    log('Starting Blackboard LMS automation (Open Source mode)');
    ...
    const result = await login_blackboard(page, {
    ...
    // const data = await enroll_students(page, {});
    // log('Data:', data);
